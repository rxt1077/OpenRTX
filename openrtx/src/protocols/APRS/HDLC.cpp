...
std::vector<uint8_t> *Decoder::operator()(const uint8_t bit)
{
    std::vector<uint8_t> *returnValue = NULL;
    ...
    DEBUG_PRINT(
        "bit=%d prevBit=%d nrziBit=%d onesCount=%d workingByte=%08b bitPos=%d\n",
